class EmploymentsController < ApplicationController
  def index
    ...
    @employments = @q.result(:distinct => true).includes(:physician, :practice).page(params[:page]).per(10)
  ...
  def create
    ...
    @employment.physician_id = params[:physician_id]
    @employment.practice_id = params[:practice_id]
